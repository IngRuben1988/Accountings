...
(function ($) {
    ...
    $.fn.excelexportjs = function (options) {
        ...
        // new code 
        function ConvertFromTableJsGrid() {
            var table = $($('#' + $settings.containerid).find("table")[0]).clone().html();
            table = table + $($('#' + $settings.containerid).find("table")[1]).clone().html();
            // $($('#jsGridFondos').find(".jsgrid-table")[0]).clone().html();

            // var result = $('<div>').append(table.clone().html());
            return table;
        }
        // new code
        ...
        function Export(htmltable) {
            ...
            if (isBrowserIE()) {
                ...
                var uri = "data:application/vnd.ms-excel;base64,name=excel";
