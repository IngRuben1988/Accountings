USE test_vtclubdb_wp_201905071347
GO

INSERT INTO [vta].[tblsegment] ([segmentName] ,[SegmentShortName] ,[segmentDescription] ,[segmentActive]) VALUES  ('HOTEL','HOTEL','',1)
...
INSERT INTO [vta].[tblcompanies] ([companyName] ,[companyShortName] ,[companyAddress] ,[companyTelephone] ,[companyActive] ,[companyOrder] ,[idSegment]) VALUES ('Grand Guadalupe by Inmense','HCG','','',1,1,1)
INSERT INTO [vta].[tblcompanies] ([companyName] ,[companyShortName] ,[companyAddress] ,[companyTelephone] ,[companyActive] ,[companyOrder] ,[idSegment]) VALUES ('LM by Inmense','HLM','','',1,3,1)
...
INSERT INTO [vta].[tblcompaniescurrencies] ([idcompany] ,[idcurrency] ,[companiescurrenciesactive]) VALUES (3,3,1)
